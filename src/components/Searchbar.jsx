  ...
  return (
    <form className="flex h-[50px] w-full md:w-[30%] items-center">
      <input
        ...
        type="text"
        className="block w-full p-4 focus:outline-none text-sm text-gray-900 bg-gray-50 border border-gray-300 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
        placeholder="Search..."
      />
      <button
